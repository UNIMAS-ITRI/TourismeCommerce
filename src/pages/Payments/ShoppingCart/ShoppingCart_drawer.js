  ...
  render() {
    ...
    let continueshopping = (
      <Box style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
        ...
        <Container style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', flex: '1' }}>
          <Box style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-start', height: '100%', paddingTop: '20px' }}>
            <Typography style={{ marginBottom: '10px' }}>Your shopping cart is empty!</Typography>
            <div  onClick={() => this.props.setCartOpen(false)}>
