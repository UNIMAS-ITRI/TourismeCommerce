...
import FullWidthTabs from "./TabsComponent/Tabs";
...
function Recommend(props) {
  ...
  const bodyDetail = [
    ...
    {
      index: 1,
      children: <ProductCard type="Restaurants" />,
      value: 1,
      type: "Restaurants",
    },
    {
      index: 2,
      children: <ProductCard type="Tourpackage" />,
      value: 2,
      type: "Tourpackage",
    },
    {
      index: 3,
      children: <ProductCard type="Ticketing" />,
      value: 3,
      type: "Ticketing",
    },
    {
      index: 4,
      children: <ProductCard type="Product" />,
      value: 4,
      type: "Product",
    },
    {
      index: 5,
      children: <ProductCard type="Transportation" />,
      value: 5,
      type: "Transportation",
    },
  ];

  const headerDetails = bodyDetail.filter((y) => y.type !== props.type).map((x) => x.type);
  const bodyDetails = bodyDetail.filter((y) => y.type !== props.type).map((x) => x.children);
  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      <div className="row justify-content-center" style={{ padding: "3vw" }}>
        ...
        <FullWidthTabs
            settings={{ Headers: headerDetails, Body: bodyDetails }}
            id="FullWidthTab"
          />
        </div>         
      </div>
