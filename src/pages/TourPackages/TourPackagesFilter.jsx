...
import { recommend, categoriesType, Division, rating, sortingOption } from './TourPackagesData';
...
class TourPackagesFilter extends Component {
    constructor(props) {
        super(props);
                    ...
                    <div className="col-lg-9 col-md-9 ">
                        <div className="d-flex sorting-options-panel align-middle px-3 mb-2 ">
                            <div className="flex-grow-1 d-flex my-auto">
                                <Typography variant='title' style={{ fontWeight: 'bold', fontSize: '2rem' }} color='#596a2a'>Tour Packages</Typography>
                            </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(TourPackagesFilter);
