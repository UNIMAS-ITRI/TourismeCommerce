...
export const VerticalProductCardListing = ({ cards, setSelectedItem, setOpenModal, page, handleOnClick, isLoding, baseColor, highlightColor }) => {
                                                ...
                                                <Grid container>
                                                    ...
                                                    <Grid item xs={6}>
                                                        <Button size="large"
                                                            ...
                                                            style={{ backgroundColor: card.ProductVariation === null || card.ProductVariation === "[]" ? "grey" : "#8fb136", color: "white", borderRadius: "0.3vw", padding: "0.25vw" }}
