...
import { recommend, categoriesType, Division, rating, sortingOption } from './TicketingData';
...
class TicketingFilter extends Component {
    constructor(props) {
        super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(TicketingFilter);
